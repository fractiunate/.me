  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=open]:bg-slate-700/50 data-[state=open]:text-white",
        className,
      )}
      {...props}
    >
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex select-none flex-col gap-1 rounded-md p-3 leading-none no-underline outline-none",
        "text-slate-300 hover:text-white hover:bg-slate-700/50",
        "focus-visible:ring-2 focus-visible:ring-[oklch(60%_.25_330)]",
        "transition-colors duration-200",
        "data-[active=true]:text-white data-[active=true]:bg-slate-700/50",
        className,
      )}
      {...props}
    />
...
function NavigationMenuViewport({
  ...
  return (
    <div className={cn("absolute top-full right-0")}>
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          "origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)]",
          "w-full overflow-hidden rounded-xl",
          "bg-slate-800/95 backdrop-blur-sm border border-slate-700/50 shadow-xl shadow-black/40",
